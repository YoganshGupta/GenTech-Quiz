 ...
 * ques47.java
 *
 * Created on Nov 9, 2017, 11:59:41 AM
 */
 ...
 * @author Admin
 */
public class ques47 extends javax.swing.JFrame {

    /** Creates new form ques47 */
    public ques47() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("7.) Who is the first Indian woman to win an Asian Games gold in 400m run?");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(8, 80, 430, 14);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(390, 230, 70, 70);
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        if(r3.isSelected()==true) {
            ...
            if(Main.k==1) {
                Main.e=(float) (Main.e + 0.5);
                Main.k=0;
            }
            if(Main.k==2) {
                Main.e=(float) (Main.e + 0.25);
                Main.k=0;
            }
            if(Main.k>=3) {
                Main.k=0;
