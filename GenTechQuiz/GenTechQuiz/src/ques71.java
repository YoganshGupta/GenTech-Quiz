 ...
 * ques71.java
 *
 * Created on Nov 9, 2017, 11:32:56 PM
 */
 ...
 * @author Admin
 */
public class ques71 extends javax.swing.JFrame {

    /** Creates new form ques71 */
    public ques71() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(40, 60, 320, 14);
    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
        ...
        if(r1.isSelected()==true) {
            ...
            if(Main.k==1) {
                Main.h=(float) (Main.h + 0.5);
                Main.k=0;
            }
            if(Main.k==2) {
                Main.h=(float) (Main.h + 0.25);
                Main.k=0;
            }
            if(Main.k>=3) {
                Main.k=0;
